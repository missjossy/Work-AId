-- Marketing Channels Analysis: Web2App vs Kochava Attribution
-- Shows source, campaigns, savings signups, and users without loans
...
WITH web AS (
    ...
    AND nvl(campaign, 'other') not in ('test', 'internal')
